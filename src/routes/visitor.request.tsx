...
//             </div>
//             <h2 className="mt-5 text-2xl font-semibold text-foreground">Request submitted</h2>
//             <p className="mt-2 max-w-sm text-sm text-muted-foreground">
//               Your visit request has been sent to the host for approval. You'll be notified once it
//               is approved and your QR pass is ready.
//             </p>
